export function Luxottica(pptx) {
  pptx.defineSlideMaster({
    ...
    objects: [
      { image: { x: 0, y: 0, w: "100%", h: 0.0555555556, path: "./srv/images/gradient.png" } },
      ...
      { image: { x: 0.3472222222, y: 7.1944444444, w: 1.2916666667, h: 0.1388888889, path: "./srv/images/Logo.png" } },
      { image: { x: 12.263888889, y: 7.125, w: 0.6805555556, h: 0.1111111111, path: "./srv/images/pallini.png" } },
      { image: { x: 0, y: 7.4583333333, w: "100%", h: 0.0555555556, path: "./srv/images/gradient.png" } },
